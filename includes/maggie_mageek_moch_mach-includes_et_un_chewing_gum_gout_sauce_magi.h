...
# define MH_CIGAM(_64)			_64 ? MH_CIGAM_64 : MH_CIGAM
# define MH_MAGIC(_64)			_64 ? MH_MAGIC_64 : MH_MAGIC
# define FAT_CIGAM(_64)			_64 ? FAT_CIGAM_64 : FAT_CIGAM
# define FAT_MAGIC(_64)			_64 ? FAT_MAGIC_64 : FAT_MAGIC
